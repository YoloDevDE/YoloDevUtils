...
Thank you for your interest in contributing! To maintain code quality and a consistent development pace, we follow a set
of best practices for Git workflows and branching.
...
- **CI (Build & Test)**: Triggered on every push and pull request to `master` and `develop`. It ensures the project
  compiles and follows our coding standards.
- **Publishing**: Triggered when a new tag is pushed (e.g., `v1.2.0`). It automatically packages the library and
